...
class Mouse(object):
    ...
    def __init__(self):
        self.mouseimg = pygame.image.load(mouseimg)
        self.mousecolimg = self.mouseimg.get_rect()
        self.mouseX = random.randint (50, 750)
        self.mouseY = random.randint (50, 550)
    ...
    def mouse_draw(self,x,y):
        ...
        screen.blit(self.mouseimg, (self.mouseX,self.mouseY))
